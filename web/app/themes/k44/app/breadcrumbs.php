...
class Breadcrumbs
{
  ...
  static $l10n = [
    ...
    'paged'      => 'Сторінка %d',
    '_404'       => 'Помилка 404',
    'search'     => 'Результат пошуку за запитом - <b>%s</b>',
    'author'     => 'Архів автора: <b>%s</b>',
    'year'       => 'Архів за <b>%d</b> рік',
    'month'      => 'Архів за: <b>%s</b>',
    'day'        => '',
    'attachment' => 'Медіа: %s',
    'tag'        => 'Записи за міткою: <b>%s</b>',
    'tax_tag'    => '%1$s із "%2$s" за тегом: <b>%3$s</b>',
  ...
  static $args = [
    ...
    'title_patt'      => '<span class="kb-title">%s</span>',
  ...
  function get_crumbs($sep, $l10n, $args)
  {
    ...
    $arg->sep = '<span class="kb-sep">' . $arg->sep . '</span>'; // дополним
    ...
    if (1) {
      ...
      if (!$mark) {
        $mark = [
          'wrappatt'  => '<div class="top__breadcrumbs">%s</div>',
      ...
      elseif ($mark === 'rdf.data-vocabulary.org') {
        $mark = [
          'wrappatt'  => '<div class="top__breadcrumbs" prefix="v: http://rdf.data-vocabulary.org/#">%s</div>',
      ...
      elseif ($mark === 'schema.org') {
        $mark = [
          'wrappatt'  => '<div class="top__breadcrumbs">%s</div>',
          'linkpatt'  => '<span itemprop="itemListElement"><a href="%s" itemprop="item"><span class="kb-title">%s</span></a></span>',
          'sep_after' => '',
        ];
