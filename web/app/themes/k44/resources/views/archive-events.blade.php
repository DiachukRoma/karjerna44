...
@section('content')
		<section class="top" style="background-image: url('{{ $back_image->top_image['url'] }}')" width="{{ $back_image->top_image['width'] }}" height="{{ $back_image->top_image['height'] }}">
				<div class="container">
						...
						<p class="top__subtitle">Lorem Ipsum є стандартною "рибою" для текстів на латиниці з початку XVI ст.</p>
				...
				<div class="container">
						<form class="widgets__search">
								<div class="search-form widgets__search-input">
										...
										<input type="text" id="text-search" class="search-form__input" value="<?php echo get_search_query(); ?>" name="s" placeholder="Пошук..." />
								</div>
		...
		<section class="worship" data-post-type="events">
				...
				<button id="load-more-posts" class="btn btn__standart worship__load-more">Завантажити ще <img src="@asset('./images/loading.svg')" alt="loading" width="28" height="28"></button>
		</section>
@endsection
