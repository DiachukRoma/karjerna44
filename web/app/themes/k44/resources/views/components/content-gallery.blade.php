<div class="content-gallery {{ $item['settings'] ? 'content-gallery__slider' : 'content-gallery__grid' }}" {!! $item['settings'] ? 'data-slides="' . $item['photo_count'] . '"' : '' !!}>
  <div class="slider">
    @foreach ($item['photos'] as $i)
      @if ($item['settings'])
  ...
  @if ($item['settings'])
    <div class="slider__navigation">
      <div class="slider__navigation-block slider__arrows">
        <button type="button" class="slider__arrow slider__arrows-left">
        ...
        <button type="button" class="slider__arrow slider__arrows-right">
          <svg xmlns="http://www.w3.org/2000/svg" width="10" height="20" viewBox="0 0 10 20" fill="none">
            <path
      ...
      <div class="slider__navigation-block slider__dots"></div>
